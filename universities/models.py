...
class University(models.Model):
    ...
    university_id = models.CharField(max_length=20, unique=True, help_text="Unique identifier for the university", default='TEMP_ID')
...
class Program(models.Model):
    ...
    program_id = models.CharField(max_length=20, unique=True, help_text="Unique identifier for the program", default='TEMP_PROG_ID')
